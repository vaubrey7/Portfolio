...
export default function Footer() {
  return (
    ...
    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <Link href="/about" className="hover:underline">Vaughn Aubrey</Link>.  All Rights Reserved.
    </span>
